import dsp from "../assets/dspp.jpg";
      ...
      <div className="flex flex-col items-center justify-center gap-10 text-white">
        ...
        >
          ...
          <p className="md:text-base text-pretty text-sm text-gray-400">
            I&apos;m a fullstack developer skilled in React.js,Node.js and Express.js
            , focused on building clean, scalable application. from fron-end
            design to seamless database integration with mongoDB, I create
